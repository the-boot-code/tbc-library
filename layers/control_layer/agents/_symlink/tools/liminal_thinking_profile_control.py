...
profile_module_name = "liminal_thinking_profile"
profile_module_control_key = "liminal_thinking_profile_control"
profile_module_display_name = "Liminal Thinking Profile"
...
class ProfileControlTool(Tool):
    ...
    async def execute(self, action: str = "", **kwargs):
        ...
        if action in ("get_state", "get_profile", "set_profile"):
        ...
        return Response(
            message=(
                ...
                "get_state, get_profile, set_profile"
            ),
            break_loop=False
        )
