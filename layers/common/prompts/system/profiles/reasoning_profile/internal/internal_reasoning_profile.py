...
class ProfileLoader:
    ...
    def __init__(self):
        ...
        self.module_title = "Internal Reasoning Profile"
        self.module_name = "reasoning_profile"
        self.module_base = "prompts/system/profiles"
        self.module_path = self.module_base + "/" + self.module_name + "/internal"
    ...
    def _load_profile_data(self) -> None:
        ...
        try:
            self.active_profile = self.system.get_active_profile("reasoning_internal")
            state = self.system.get_state("reasoning_internal")
