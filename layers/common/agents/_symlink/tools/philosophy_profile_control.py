...
class PhilosophyProfileControlTool(Tool):
    ...
    async def _get_status(self, system: SystemControl) -> Response:
        ...
        state = system.get_state("philosophy")
    ...
    async def _get_profile(self, system: SystemControl) -> Response:
        ...
        profile_name = system.get_active_profile("philosophy")

        return Response(
            message=f"Active Philosophy Profile: {profile_name}",
            break_loop=False
        )
    ...
    async def _set_profile(self, system: SystemControl, kwargs: dict) -> Response:
        ...
        if not profile:
            available = system.get_available_profiles("philosophy")
            return Response(
        ...
        result = system.set_active_profile("philosophy", profile)
