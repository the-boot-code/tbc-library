...
- _symlink is mapped via docker compose as an agent profile /a0/agents/_symlink/ and contains the **centralized files** for agent profile extensions, prompts, and tools to be **linked** to from other profiles such as seen in **a0-template**
